...
function Template2() {
    ...
    return (
        <div className='template1-parent'>
            ...
            <div className='objective mt-1'>
                <h3 style={{backgroundColor:'grey', padding:10}}>Objective</h3>
                <hr></hr>
            ...
            <div className='education mt-5'>
                <h3 style={{backgroundColor:'grey', padding:10}}>Education</h3>
                <hr />
            ...
            <div className='experience mt-5'>
                <h3 style={{backgroundColor:'grey', padding:10}}>Experience</h3>
                <hr />
            ...
            <div className='projects mt-5'>
                <h3 style={{backgroundColor:'grey', padding:10}}>Projects</h3>
                <hr />
            ...
            <div className='skills mt-5'>
                <h3 style={{backgroundColor:'grey', padding:10}}>Skills</h3>
                <hr />
